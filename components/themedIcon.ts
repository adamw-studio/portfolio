...
// near-white (#F4F4F4-based) glyph — arrows, the nav's theme/menu icons,
// the Beacon logomark. Figma's own per-theme exports of these turned out
// unreliable (some, like the main logo, correctly re-export as #0D0D0D
// for light mode; others, like the nav's sun/moon icons, still came back
// #F4F4F4 even in the light-mode fetch — a known Figma export quirk, not
// a real light-mode spec). Inverting is simpler and provably correct for
// any of these
