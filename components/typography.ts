...
// back). No font-medium since Gentium Basic has no medium weight (Figma
// doesn't call for one here either).
export const heading = "font-serif text-[20px] leading-6 tracking-[-0.8px] text-text-primary";
