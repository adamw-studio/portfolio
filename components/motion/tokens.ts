...
export const ICON_DURATION_SNAPPY = "duration-[250ms]"; // craft in canvas & code's "spring scale"
...
// No overshoot, for translate/rotate movements.
export const EASE_SMOOTH = "ease-[cubic-bezier(0.4,0,0.2,1)]";
